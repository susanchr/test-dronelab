...
function AlertElementDetailsImgPopup(props:{open:boolean,setClosed:()=>any,img:string,title:string}) { // TODO change from any
...
export default AlertElementDetailsImgPopup;